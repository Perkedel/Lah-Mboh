...
// here example about greetable characters
// (JOELwindows7)

class LMBH_GreetableCharacter_DoomPlayer : LMBH_GreetableCharacter
{
    Default
    {
...
// okay fine I prompt it but because it's just for repetitive shits!
// never to `here pls code for me I'm lazy` no!
// I had to Ctr+D & then edito each part of it, cumbersome!!
// With AI, I just say `pls copy and edito as above, with the reference you got` bla bla bnlafasjkdhfka
